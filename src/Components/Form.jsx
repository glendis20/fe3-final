...
const Form = () => {
  ...
  // Mensajes:
  const errMessage = {
    errName: "El nombre proporcionado es incorrecto, Verificalo por favor",
    errEmail: "El correo proporcionado es incorrecto. Verificalo por favor",
  };
  const successMessage = `Gracias! ${leadData.name.value} Nuestro equipo estará en contacto!`;
